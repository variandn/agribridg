    ...
    <%@ page import="Servlets.PasswordUtils, Servlets.HtmlUtils" %>
        <%@ page import="jakarta.servlet.http.*, jakarta.servlet.*" %>
            <%@ page contentType="text/html;charset=UTF-8" language="java" %>
                ...
                <% String message="" ; boolean redirecting=false; String identifier=request.getParameter("username")
                    !=null ? request.getParameter("username").trim() : "" ; String
                    password=request.getParameter("password") !=null ? request.getParameter("password").trim() : "" ;
                    String userId=null; String role=null; String userName=null; if
                    ("POST".equalsIgnoreCase(request.getMethod())) { if (identifier.isEmpty() || password.isEmpty()) {
                    message="Username/email and password are required." ; } else { try { MongoDatabase
                    db=MongoDBConnection.getDatabase(); // Find user by identifier only (not password)
                    ...
                    MongoCollection<Document> sessions = db.getCollection("sessions");
                        ...
                        <head>
                            ...
                            <meta name="description"
                                content="Login to AgriBridge - Your trusted agricultural marketplace connecting farmers, buyers, and sellers.">
                            ...
                            <style>
                                ...
                                *::after {
                                ...
                                .brand-panel {
                                    flex: 1;
                                    background: linear-gradient(160deg, var(--dark) 0%, var(--dark-secondary) 40%, var(--primary-deeper) 100%);
                                    display: flex;
                                ...
                                .float-el:nth-child(3) {
                                    ...
                                    top: 35%;
                                    left: 80%;
                                    animation: floatAnim 7s ease-in-out infinite 4s
                                }
                                ...
                                .float-el:nth-child(4) {
                                    ...
                                    top: 75%;
                                    left: 25%;
                                    animation: floatAnim 9s ease-in-out infinite 1s
                                }
                            ...
                            <div class="login-page">
                                <div class="brand-panel">
                                    ...
                                    <div class="brand-content">
                                        ...
                                        <p class="brand-desc">Join thousands of farmers and buyers across Africa trading
                                            fresh agricultural produce on a platform built for trust and transparency.
                                        </p>
                                        <div class="trust-badges">
                                            <div class="trust-badge"><span class="badge-num">1K+</span><span
                                                    class="badge-lbl">Farmers</span></div>
                                            <div class="trust-badge"><span class="badge-num">30+</span><span
                                                    class="badge-lbl">Products</span></div>
                                            <div class="trust-badge"><span class="badge-num">99%</span><span
                                                    class="badge-lbl">Satisfaction</span></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <% if (!message.isEmpty()) { %>
                                            ...
                                            <% } %>
                                                ...
                                                <form method="post" id="loginForm">
                                                    ...
                                                    <button type="submit" class="btn-login" id="loginBtn">Sign
                                                        In</button>
                                                </form>
